...
<s:form id="personForm" action="savePerson" method="post" validate="true">
    ...
    <s:textfield key="person.firstName" required="false" maxlength="255" cssClass="text medium"/>
    <s:textfield key="person.lastName" required="false" maxlength="255" cssClass="text medium"/>
